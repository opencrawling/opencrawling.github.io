...
OpenCrawling is a high-performance enterprise data ingestion and security mapping framework. It bridges siloed content stores (SharePoint, Amazon S3, Databases) to AI and vector search infrastructure (pgvector, Apache Solr, Luxir, Qdrant, Vespa) while fully respecting document Access Control Lists (ACLs).
